...
DEFINE_SIMPLE_STRICT_OPERATION(RatioP, (dynamic_cast<Ratio*>(argument) !=NULL||dynamic_cast<Ratio*>(argument) != NULL))
DEFINE_SIMPLE_STRICT_OPERATION(RatioNumeratorGetter, Ratio_getA(ensureRatio(argument)))
DEFINE_SIMPLE_STRICT_OPERATION(RatioDenominatorGetter, Ratio_getB(ensureRatio(argument)))
