...
DEFINE_SIMPLE_STRICT_OPERATION(IntSucc, intASucc(argument))
...
DEFINE_SIMPLE_STRICT_OPERATION(IntegerSucc, integerASucc(argument))
REGISTER_STR(Int, {
...
DEFINE_SIMPLE_STRICT_OPERATION(IntP, (dynamic_cast<Int*>(argument) != NULL))
DEFINE_SIMPLE_STRICT_OPERATION(IntegerP, (dynamic_cast<Int*>(argument) !=NULL||dynamic_cast<Integer*>(argument) != NULL))
