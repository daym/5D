...
DEFINE_SIMPLE_OPERATION(TailGetter, ((argument = reduce(argument), cons_P(argument)) ? reduce(((AST::Cons*) argument)->tail) : str_P(argument) ? makeStrSlice((AST::Str*) argument, 1) : FALLBACK))
