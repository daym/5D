...
DEFINE_SIMPLE_OPERATION(FstGetter, ((argument = reduce(argument), pair_P(argument)) ? AST::get_pair_first(argument) : FALLBACK))
DEFINE_SIMPLE_OPERATION(SndGetter, ((argument = reduce(argument), pair_P(argument)) ? AST::get_pair_second(argument) : FALLBACK))
