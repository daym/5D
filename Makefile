...
CXXFLAGS += -Wall -I. -g3 -fno-strict-overflow -Wno-deprecated `pkg-config --cflags glib-2.0 gthread-2.0 libxml-2.0` $(LIBGC_LD_WRAP_CFLAGS) -DGC_DEBUG
PACKAGE = 5D
...
installgui:
	...
	install -m 644 doc/tips $(DESTDIR)/usr/share/doc/5D/tips
