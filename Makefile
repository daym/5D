...
CXXFLAGS += -g3 -Wall -I. -fno-strict-overflow -Wno-deprecated `pkg-config --cflags glib-2.0 gthread-2.0 libxml-2.0 libffi` $(LIBGC_LD_WRAP_CFLAGS) -pthread -D_FILE_OFFSET_BITS=64 -Wno-unused-function
ifdef PREFIX
